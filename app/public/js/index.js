            ...
            $.post("/artists",data,function(result){
                ...
                for (var i = 0; i<items.length; i++)
                {
                    ...
                    // }
                     ...
                     var button = $("<button></button>");
                    button.attr("id", item.artistID);
                    //button.addClass("addBtn");
                    button.addClass("addArtist");
                    button.html("Add");
                    var td = $("<td></td>");
                    td.append(button);
                    button.click(postData);
            ...
            $.post("/tracks",data,function(result){
                ...
                */ //HIDDEN FEB 27 18
                ...
                for (var i = 0; i<items.length; i++)
                {
                    ...
                    var output = "<td>" + '<img src="' + item.images[i].url + '"></td>'; 
                      output += "<td>" + item.trackName + "</td>";
    ...
    function postData()
    {
       //alert("INSIDE BUTTON!");
        ...
        if(className == "addArtist"){
            console.log("ISSA ARTIST");
            
             var data = {
            item: artistInfo[id] 
            };
            $.post("/saveArtist",data,function(result){
